"""
Unified Opal Tools API for Vercel Deployment
Combines all tools from the python/ directory into a single FastAPI application
"""
...
app = FastAPI(title="Unified Opal Tools Service - Vercel Deployment")
